...
//Класс StudentGroupService имеет несколько обязанностей: создание группы студентов,
// и сортировка. Вынесем сортировку в отдельный класс.
public class StudentGroupService {
    ...
    public List<Student> getSortedStudentGroup() {
        return studentSorter.sortStudents(new ArrayList<>(studentGroup.getStudents()));
    }

    public List<Student> getSortedByFIOStudentGroup() {
        List<Student> students = new ArrayList<>(studentGroup.getStudents());
        return studentSorter.sortByFIO(students);
    }
}
